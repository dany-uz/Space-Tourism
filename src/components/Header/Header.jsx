                    ...
                    <div className={styles.mobileMenu}>
                        ...
                        {menuOpen && (
                            <div className={styles.mobileMenuItems}>
                                ...
                                <NavLink className="text-preset-8" onClick={toggleMenu} to="/" end><span className='text-preset-8-bold'>00</span> Home</NavLink>
                                <NavLink className="text-preset-8" onClick={toggleMenu} to="/destination" end><span className='text-preset-8-bold'>01</span> Destination</NavLink>
                                <NavLink className="text-preset-8" onClick={toggleMenu} to="/crew" end><span className='text-preset-8-bold'>02</span> Crew</NavLink>
                                <NavLink className="text-preset-8" onClick={toggleMenu} to="/technology" end><span className='text-preset-8-bold'>03</span> Technology</NavLink>
                            </div>
                        )}
                    </div>
                ) : (
